...
def main():
    """User input begin"""
    path_to_files = "~/Downloads/scratch/two_spheres/"
    files = (
        "cell_size_4_pillow_adapt_10cm_aspect_ratio.csv",
        "cell_size_4_pillow_adapt_10cm_scaled_jacobian.csv",
        "cell_size_4_pillow_adapt_10cm_skew.csv",
    )
    fig_dict = {
        "title": "cell size 4 pillow adapt 10cm",
        "xlabel": "",
